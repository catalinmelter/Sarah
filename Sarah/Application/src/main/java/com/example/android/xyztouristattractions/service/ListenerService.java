...
public class ListenerService extends WearableListenerService {
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if (Constants.CLEAR_NOTIFICATIONS_PATH.equals(messageEvent.getPath())) {
        ...
        } else if (Constants.START_SHOP_PATH.equals(messageEvent.getPath())) {
            // Request for this device open the shop detail screen
            // to a specific shop
            String shopName = new String(messageEvent.getData());
            Intent intent = DetailActivity.getLaunchIntent(this, shopName);
            ...
            // specific tourist shop
            String shopQuery = new String(messageEvent.getData());
            Uri uri = Uri.parse(Constants.MAPS_NAVIGATION_INTENT_URI + Uri.encode(shopQuery));
